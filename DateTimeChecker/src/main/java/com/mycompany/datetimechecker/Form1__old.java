 ...
 * @author Huu Minh
 */
public class Form1__old extends javax.swing.JFrame {

    Logger logger = Logger.getLogger(Form1__old.class.getName());
     ...
     */
    public Form1__old() throws IOException {
        ...
        jCheck.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                try {
                    ...
                    Logger.getLogger(Form1__old.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
...
//        jLogo.setIcon(new javax.swing.ImageIcon(DIR + "img\\FPTU_logo.png")); // NOI18N
        jLogo.setIcon(new javax.swing.ImageIcon(DIR + "img\\FPTU_logo.pmg")); // NOI18N
